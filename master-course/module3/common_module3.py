...
def embed_figure_row(db, paths_labels, caption, max_h=230):
    """Embeds N images in an evenly divided row (e.g. a multi-part CAM
    figure that spans several source pages) with a shared caption."""
    from reportlab.lib.utils import ImageReader
    n = len(paths_labels)
    gap = 12
    col_w = (CW - gap * (n - 1)) / n
