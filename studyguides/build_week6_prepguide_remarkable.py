...
from common_v2_remarkable import *

OUT = "/home/claude/ac300wk6/out/AC300_Week6_PrepGuide_v2_reMarkable.pdf"
TOTAL_PAGES = 10
...
cards = [
    ("A", "Learning Targets \u2014 I Can Statements", "Pre/post confidence ratings 1-5 for 10 learning outcomes"),
    ("B", "Activate \u2014 Connect to What You Know", "Bridge from Week 5 BL/KI to PC/SJ/GB/LR; fill-in prompts"),
    ("C", "Vocabulary Pre-Load", "17 key terms: Pinyin, English, space for your definition"),
    ("D", "Anticipatory Questions", "10 questions (PC+SJ+GB+LR); starred = high-challenge/high-yield"),
...
y = purpose_box(c, y, [
    ...
    "Goal: All 10 targets at 4-5 by end of your Week 6 review session. Below 3 = highest review priority.",
])
y = purpose_box(c, y, [
...
targets = [
    ...
    "Identify high-yield PC/SJ points: PC6, PC7, PC8, TE5, TE17, TE23 -- categories and key indications.",
    "Identify high-yield GB/LR points: GB20, GB21, GB34, GB41, LR3, LR8, LR14 -- categories and key indications.",
...
qs = [
    ...
    (12, "ACQ", "LR14 (Qimen): type of point + what it treats."),
]
for n, tag, t in qs:
    y = checkpoint_item(c, y, n, tag, t)
y = selfcheck_line(c, y, 4)
...
answers = [
    ...
    "Front-Mu of the Liver; hypochondriac pain, emotional disorders",
    "Chest to hand",
    "Head to foot",
    "PC 7-9 PM; LR 1-3 AM",
