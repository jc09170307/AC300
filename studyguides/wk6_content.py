...
# ---------------------------------------------------------------------------
PC_META = [
    ("Pertaining", "Pericardium (Xin Bao)"),
    ("Connecting", "San Jiao (Triple Energizer)"),
    ...
    ("Back-Shu", "BL14 Jueyinshu"),
    ("Front-Mu", "CV17 Danzhong (Shanzhong)"),
    ("Yuan-Source", "PC7 Daling"),
    ("Luo-Connecting", "PC6 Neiguan"),
    ("He-Sea", "PC3 Quze"),
    ("Xi-Cleft", "PC4 Ximen"),
...
SJ_META = [
    ("Pertaining", "San Jiao / Triple Energizer (function organ, no physical organ)"),
    ...
    ("Back-Shu", "BL22 Sanjiaoshu"),
    ("Front-Mu", "CV5 Shimen"),
    ("Yuan-Source", "SJ4 Yangchi"),
    ("Luo-Connecting", "SJ5 Waiguan"),
    ("He-Sea", "SJ10 Tianjing"),
    ("Xi-Cleft", "SJ7 Huizong"),
    ("Confluent (opens EV)", "SJ5 Waiguan -- opens Yang Wei Mai, paired with GB41"),
...
GB_META = [
    ...
    ("Back-Shu", "BL19 Danshu"),
    ("Front-Mu", "GB24 Riyue"),
    ("Yuan-Source", "GB40 Qiuxu"),
    ("Luo-Connecting", "GB37 Guangming"),
    ("He-Sea", "GB34 Yanglingquan -- also the Hui-Meeting Point for SINEWS/TENDONS"),
    ("Xi-Cleft", "GB36 Waiqiu"),
    ("Confluent (opens EV)", "GB41 Zulinqi -- opens Dai Mai (Girdle Vessel), paired with SJ5"),
...
LR_META = [
    ...
    ("Back-Shu", "BL18 Ganshu"),
    ("Front-Mu", "LR14 Qimen"),
    ("Yuan-Source", "LR3 Taichong"),
    ("Luo-Connecting", "LR5 Ligou"),
    ("He-Sea", "LR8 Ququan"),
    ("Xi-Cleft", "LR6 Zhongdu"),
