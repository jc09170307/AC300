...
CATS = [
    ...
    ("CROSSING POINTS", "A point on one channel that is also crossed by one or more OTHER channels' pathways.",
     ["PC + LR: ZERO/minimal crossing points this week (PC has none). SJ + GB: extensive overlap around the head/ear/shoulder (both Shaoyang channels).",
      "GB's 12 crossing points (2026 deck, confirmed) -- SJ: Yifeng SJ17, Jiaosun SJ20, Erheliao SJ22 | LR: Dadun LR1, Zhangmen LR13 | PC: Tianchi PC1 | SI: Bingfeng SI12, Tianrong SI17, Tinggong SI19 | ST: Xiaguan ST7, Touwei ST8 | GV: Dazhui GV14"], GOLD),
