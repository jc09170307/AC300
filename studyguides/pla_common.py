...
# ---- Edition support (Print vs reMarkable delta spec) ----
LW_MULT = 1.0
HEADER_BAR_H = 40

def set_edition(remarkable):
    global PAGE_BG, CARD_BG, MINT, LW_MULT, HEADER_BAR_H
    if remarkable:
        PAGE_BG = (0.973, 0.953, 0.902)   # ivory
        CARD_BG = (0.925, 0.902, 0.855)   # parchment row tint
        MINT = (0.902, 0.898, 0.858)      # callout tint, distinct from ivory bg
        LW_MULT = 1.35
        HEADER_BAR_H = 51
    else:
        PAGE_BG = WHITE
...
PAGE_BG = WHITE  # default; overridden by set_edition()
