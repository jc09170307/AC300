...
from midterm_questions import SECTIONS, TOTAL_Q
...
if IS_RM:
    ...
    OUT = "/mnt/user-data/outputs/AC300_PracticeMidterm_Wk1-4_reMarkable.pdf"
    ...
    HAIRLINE = 0.5
    WRITE_FILL = (1, 1, 1)
    OUT = "/mnt/user-data/outputs/AC300_PracticeMidterm_Wk1-4_Print.pdf"
...
def header(subtitle):
    ...
    c.drawString(36, H - HEADER_H + 15, "AC300 PRACTICE MIDTERM")
...
def footer(page_label):
    ...
    c.drawCentredString(W / 2, 22, f"AC300/AC375 Practice Midterm (Wk 1-4)  \u00b7  VUIM Summer 2026  \u00b7  {page_label}")
...
c.drawCentredString(W / 2, H - 227, "PRACTICE MIDTERM")
...
howto = [
    ...
    "Several questions below are adapted directly from verified Quiz 1-3 material \u2014",
    "Dr. Zhang has said the midterm reuses a number of quiz questions.",
]
yy = by0 - 42
for line in howto:
