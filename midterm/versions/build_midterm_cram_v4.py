...
# ============= PAGE 3: Special Point Category Legend =============
...
legend_rows = [
    ("Jing-Well", "Distal-most point on the channel (fingertip/toenail); channel's start or end; treats acute/mental disturbance", "LU11, HT9, LI1, ST45, SP1, SI1"),
    ...
    ("He-Sea", "Where Qi enters deepest into the body; treats organ-level / internal disorders", "LU5, LI11, ST36, SP9, HT3, SI8"),
