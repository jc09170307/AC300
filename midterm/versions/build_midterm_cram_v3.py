...
y -= 20
callout(36, y+8, W-72, ["Paired organs sit in adjacent clock slots (LU/LI, ST/SP, HT/SI) \u2014 the Qi circulation chain flows straight from one into the next. Muted wedges (BL/KI/PC/SJ/GB/LR) are covered in later weeks."], accent=GOLD, font_size=8.2)
y -= 36
